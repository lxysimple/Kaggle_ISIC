...
def prepare_loaders(df, fold):
    ...
    train_dataset_others = ISICDataset_for_Train_fromjpg('/home/xyli/kaggle/data2020', transforms=data_transforms["train"])
    ...
    train_loader = DataLoader(train_dataset_others, batch_size=CONFIG['train_batch_size'], 
